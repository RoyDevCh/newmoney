...
5. ??????? ComfyUI ?????
6. Dashboard ???????????????????????????????Agent ???
7. ????? `metrics_analysis_latest.json` ????????Hook?CTA??????
8. ??????????????`?? SearXNG -> ddgs / duckduckgo_search -> Bing RSS`?
9. `2026-03-10` ????????????????????????`gather_research_context()` ???? `ddgs` ???????????????????????????
...
2. ?????????????????????????
3. ??????????????????????????????????
4. ?????? `127.0.0.1:8080` ?????????? `SearXNG` ????????????????????
5. ???????????????????? `?? SearXNG -> ddgs / duckduckgo_search -> Bing RSS`????? `ddgs` ????????????????????????????????
6. ???????? `C:\Users\Roy\.openclaw\workspace` ???? `content_quality_gate.py`???? `content_autotune_runner.py` ???????????????????????????
7. ???????????????? + ?????????????????
8. ?????????????????????????????????
...
1. ????????????????????????????????
2. ???????????????`?? SearXNG -> ddgs / duckduckgo_search -> Bing RSS`?
3. `2026-03-10` ?????????? `192.168.3.120` ? `127.0.0.1:8080` ????Docker ???? `SearXNG` ????????????????????
4. ?????????`ddgs` ? `duckduckgo_search` ??????`gather_research_context()` ?????????????? `8` ????????????? `?? / B? / ???? / ???`?
5. ?????????????????????????????????? `127.0.0.1:8080` ??????????????????????
6. ????????????????? `content_autotune_runner.py`?`local_search_client.py`?`news_guard.py`?`content_quality_gate.py` ??? `C:\Users\Roy\.openclaw\workspace`?
...
3. 热点与资料抓取的代码入口已经切到本地搜索优先，但还缺远端生产环境实测验证。
...
1. ??????????????????????????????????????
2. ???????????????????????????? `127.0.0.1:8080` ? `ddgs` ?????????? prompt?
3. ?? Docker ????? `openclaw_chat` ??????? `SearXNG`??????????????????? Windows ???
4. ?????????????????????????? `content_quality_gate.py` ????????`local_search_health().ok` ?????`ddgs` ??????
...
1. 本地搜索引擎主链化。
   当前系统已经完成代码接入：选题校验和 research context 都已优先走本地搜索适配层。下一步不是重新设计，而是做远端生产环境的连通验证、来源白名单细化和结果质量回归。
2. 视频链路升级。
...
6. 已新增 `local_search_client.py`，并把 `news_guard.py`、`content_autotune_runner.py` 切到本地搜索优先；当前会话环境未验证本地 SearXNG 端口可达。
7. ??????????????? `?? SearXNG -> ddgs / duckduckgo_search -> Bing RSS`???????????? `ddgs` ?????????????
8. ?? `content_autotune_runner.py` ?? `fallback_strategy`???????????????????????????????? `main-brain` ?????????????????
9. ??????????? `codex_pack_final_20260310_010728_b.json`?????????20+??????????2026?????????? 1647 ??????? 98??????????????
10. 2026-03-10 ????????????`content_autotune_runner.py` ?? `enforce_publish_safe_evidence()`?`strip_research_trace_lines()`?`normalize_case_story()`?`strip_meta_prefixes()`???? `sanitize_draft()` ???????????????????????Hook/CTA ???????
11. ???????????`zhihu_direct_publish_20260310.md`?`wechat_direct_publish_20260310.md`?`xiaohongshu_direct_publish_20260310.md`????????????????????????????????????????????? JSON ??????
12. ??????????????????????????????????????????????????????????????? sanitizer ???????????????????????????????
13. 2026-03-10 ??????????????`zhihu_direct_publish_with_images_20260310.md`??????????????????????????????????????????????????????????????????????? + 3 ? 7 ???????????????????
14. 2026-03-10 ????????????`generate_zhihu_preview_images.py`????????????/??????????????????????????????????????????????????
15. 2026-03-10 ??????????`real_image_reference_builder.py`?????????????????????????? + ????????????`generate_pack_assets.py` ? `real_reference_preferred` ?????? `real_image_entrypoints`?`real_image_candidates`?`real_image_slot_plan` ???????????????????????????????????? `og:image` / `twitter:image`????????? research context ?????????????????????????
16. 2026-03-10 ??????????`publish_review_zhihu_20260310.md`?????????????????????????????????????????????????????
17. 2026-03-10 ??????????`zhihu_publish_ready_20260310_final.md`??????????????????????????????????????????????????????
18. 2026-03-10 ????? PDF ???`generate_publish_pdf_zhihu_final.py` ? `publish_assets/zhihu_final_20260310/zhihu_publish_ready_20260310_final.pdf`????????? PDF ???????????????? PDF ??????? + ??????? + ??????
19. 2026-03-10 ???????????`vertical_content_policy.py`??????????????????????????????????????????????????????????????????????????????????? B ? / ???????????????? `autopipeline_brain_content_publisher.py` ????????????????? `topic_policy` ?????
20. 2026-03-10 ?????????????????`content_autotune_runner.py` ????????? / ???????? `fallback_strategy()`?`build_strategy_prompt()`?`build_init_prompt()`?`clean_meta_template()`?`clean_blueprint_blocks()` ?????????????????/?????????????????????????????????????????


21. 2026-03-10 ??? `platform_direction_policy.py`??????????????????????????????? + ?????/???????????????????????????????????????? `autopipeline_brain_content_publisher.py` ? `content_autotune_runner.py`????????????????????
22. 2026-03-10 ??? `ZHIHU_DIRECTION_BLUEPRINT_20260310.md`???????? deep research ???????????????????????????????????????????????????????????????????????????????????????????? prompt?

23. 2026-03-10 ????????????????????`article`???????? `answer`??????????????? `content_autotune_runner.py` ? `infer_zhihu_format()`???????/??/??/??/???????????/???/?????/???/??????????????????
24. 2026-03-10 ?????????? `compress_zhihu_repeat_blocks()`??????????????????????????????????????????????
25. 2026-03-10 ????????????????????`zhihu_article_baseline_20260310.md` ? `zhihu_answer_baseline_20260310.md`???????????????????????????????????????

26. 2026-03-10 ??? `consumer_product_knowledge.py`??????????????????? / ????????????????????????????????????? `decision_factors`?`budget_bands`?`brand_positions`?`scenarios`?`avoid` ???????? `content_autotune_runner.py` ??????????????????
27. 2026-03-10 ?? `content_autotune_runner.py` ??? `build_product_knowledge_blocks()`??????????????????????????????????????????
28. 2026-03-10 ??? `zhihu_smartwatch_knowledge_baseline_20260310.md` ? `zhihu_smartwatch_publish_ready_20260310_v2.md` ??????????????????????????? + ???????????????

29. 2026-03-10 ????? Windows ?????????? PowerShell heredoc ????????????????????????? `?`??????????? `apply_patch` ???? UTF-8 ?????????????????? `zhihu_smartwatch_publish_ready_20260310_v2.md`?

31. 2026-03-10 ?????????????????? `consumer_product_knowledge.py` ???????????????? `series_matrix`???? `build_series_markdown_table()` ?? Markdown ???????????????????????? / ????? / ????????????
32. 2026-03-10 ??? `zhihu_smartwatch_publish_ready_20260310_v4.md`????????????? -> ?? -> ?? -> ????????????????????????????????

33. 2026-03-10 ?????????????????????????? `consumer_product_knowledge.py` ?? `series_matrix`???? `shortlist` ? `official_sources`??????????????????????????????????
34. 2026-03-10 ??? `zhihu_smartwatch_publish_ready_20260310_v5.md`?????????????????????????????????????????????????????????????????

35. 2026-03-10 ??? `content_novelty_policy.py`??????????????????? `topic_rotation_state.json` ????????????? `topic/platform/title/lane/sublane/product_family`??????????????????? 30-45 ???????????????????????? prompt ??????????????????????????????Hook ??????????
36. 2026-03-10 ??????????? `autopipeline_brain_content_publisher.py` ? `content_autotune_runner.py`?????????????????????????????????? + ????? + ??????????

37. 2026-03-10 ??????????????????????????? `zhihu_router_publish_ready_20260310_v1.md`?????????????????????/???? + ?????? + ??????????????????????????????
38. 2026-03-10 `consumer_product_knowledge.py` ??????? `series_guidance`?`series_matrix`?`shortlist`?`official_sources`?????????????????????????????????

39. 2026-03-10 ??? `content_formula_policy.py`???????? 4 ??????`search_buying_guide`?`single_product_review`?`launch_roundup`?`answer_decision`???????????????????????/??/??????
40. 2026-03-10 ????????? / ??????????? `content_autotune_runner.py` ?????????????????????????????????????? + ???? + ????/?????????????????????
41. 2026-03-10 ?? `vertical_content_policy.py` ?????????????? `Apple Watch Series 11 ??????????????????????` ? `???? X1 ??????????????????????`????????????????
42. 2026-03-10 ??? `zhihu_watch11_review_publish_ready_20260310_v1.md`???????????????????????????????????/?????????????
43. 2026-03-10 已把《面向自动化系统的知乎单品文章生产深度研究报告》的核心规则接入系统：新增 5 个知乎单品子模板，分别是快速结论型、营销打假型、体验分层型、工程硬核型、汽车上市说明书型。
44. 2026-03-10 `content_formula_policy.py` 已支持主母版 + 单品子模板双层判断；`build_formula_prompt_hint()` 现在会把单品模板、必备结构和开篇要求一并注入生成链。
45. 2026-03-10 `content_autotune_runner.py` 已新增 `build_single_product_rules()` 与 `build_evidence_writing_rules()`：单品稿强制区分“已确认 / 高概率成立 / 仍待验证”，并要求显式写清证据口径、适合谁、不适合谁、现在买还是等等。
46. 2026-03-10 `content_quality_gate.py` 已新增单品文章证据密度与营销话术检查：`single_product_evidence_weak`、`marketing_hype_heavy`。这两项会阻止明显“宣传味重、证据弱”的单品稿进入发布队列。
47. 2026-03-10 新增单品蓝图文档 `ZHIHU_SINGLE_PRODUCT_BLUEPRINT_20260310.md`，用于后续接手开发时快速理解知乎单品文章的证据结构、模板分层与迭代方向。
48. 2026-03-10 已产出新的单品样稿 `zhihu_watch11_review_publish_ready_20260310_v2.md`，该稿按“结论型 + 证据分层 + 待验证区”重写；本地质检得分 93/100，当前问题仅为正文略长，可作为下一轮知乎正式图文版母稿。
49. 2026-03-10 图片链路新增“禁去水印”硬规则：系统不再尝试处理任何带水印素材，而是在 `real_image_reference_builder.py` 中前置过滤高水印风险来源，只保留可直接使用的官方图、产品页图和低风险候选。
50. 2026-03-10 `real_image_reference_builder.py` 已新增 `watermark_risk_score`、`watermark_risk_reasons`、`accepted`、`usage_policy` 字段，并把小红书、微博、B站、抖音、西瓜等社交/视频来源视为高风险候选，默认拒绝作为正式发布图。
51. 2026-03-10 `generate_pack_assets.py` 已把 `real_image_policy`、`real_image_rejected_candidates` 一并写回资产结果，后续 Dashboard 和发布队列可以直接展示“为什么这张图能用、为什么那张图被拒绝”。
52. 2026-03-10 已为 Apple Watch Series 11 单品稿生成官方无水印素材包：`publish_assets/zhihu_watch11_v2/`，其中 `01_official.jpg`、`02_official.jpg`、`03_official.jpg` 均来自 Apple 官方页面，水印风险分数为 0，可作为正式图文版的基础素材。
53. 2026-03-10 已产出 Apple Watch Series 11 单品稿正式图文版：`zhihu_watch11_publish_ready_20260310_final.md`，正文已插入 3 张官方无水印图片，适合直接作为知乎图文发布底稿审阅。
54. 2026-03-10 已生成 Apple Watch Series 11 单品稿正式 PDF：`publish_assets/zhihu_watch11_v2/final/zhihu_watch11_publish_ready_20260310_final.pdf`，并导出 `pdf_preview_page_1.jpg`、`pdf_preview_page_2.jpg`、`pdf_preview_page_3.jpg` 供快速预览最终上线版式。
55. 2026-03-10 已把“专业单品稿必须覆盖具体维度”接入系统：`consumer_product_knowledge.py` 为智能手表、路由器新增 `review_dimensions`、`previous_gen_compare`、`peer_compare`，不再允许单品稿只停留在泛判断层。
56. 2026-03-10 `content_autotune_runner.py` 已新增对单品稿的硬约束：至少覆盖 5 个具体评测维度；电子产品和汽车优先补“和上一代比”；若没有清晰上代，则必须补“和同品类/同价位比”。
57. 2026-03-10 `content_quality_gate.py` 已新增 `single_product_comparison_weak` 检查，避免单品稿只有结论和立场，没有实际可用的对比信息。
58. 2026-03-10 已重写 Apple Watch Series 11 正式稿为 `zhihu_watch11_publish_ready_20260310_final_v2.md`，新版本补入健康功能、外观材质、续航与充电、运动/GPS、生态联动、佩戴舒适度等维度，并显式补入与上代、SE 3、Ultra 3、华为 WATCH、Garmin Forerunner 的对比逻辑。
59. 2026-03-10 已参考《资深评测编辑级知乎单品文章的统一方法论与自动化体系》把“统一字段模型 UFM”接入系统：新增 `zhihu_editorial_ufm.py`，把单品稿统一为“三账本、两条链、三层输出”。
60. 2026-03-10 三账本已作为知乎单品稿默认方法论：事实账本=硬事实与规格；方法账本=测试条件与口径；信号账本=社区反馈与早期口碑，仅作风险雷达，不作硬事实。
61. 2026-03-10 三层输出已作为知乎单品稿默认结构：L0 结论卡；L1 可比矩阵；L2 证据与方法附录。后续若生成的知乎单品稿没有矩阵表或附录说明，应视为结构不完整。
62. 2026-03-10 `content_autotune_runner.py` 已把 UFM 规则注入策略 prompt、初稿 prompt、重写 prompt；知乎单品稿现在默认被要求产出 L0/L1/L2 结构，并补足同口径对比与待验证项。
63. 2026-03-10 `content_quality_gate.py` 已新增 `single_product_matrix_missing` 检查，避免单品稿只有观点和段落，没有真正可比较的表格化信息。
64. 2026-03-10 已新增更接近“资深评测编辑稿”的 Apple Watch 样稿：`zhihu_watch11_publish_ready_20260310_final_v3.md`。该版本已按 L0/L1/L2 结构输出，并包含 6 维评测矩阵、上代/同类对比与证据口径附录。
65. 2026-03-10 已新增更适合正式发稿节奏的收束版本：`zhihu_watch11_publish_ready_20260310_final_v4.md`。该版本保留 L0/L1/L2 结构，但压缩了重复解释，信息密度更高，适合知乎正式图文发布。
66. 2026-03-10 已生成 `v4` 正式 PDF：`publish_assets/zhihu_watch11_v4/final/zhihu_watch11_publish_ready_20260310_final_v4.pdf`，并导出 `pdf_preview_page_1.jpg`、`pdf_preview_page_2.jpg`、`pdf_preview_page_3.jpg` 用于快速审版。
67. 2026-03-10 当前 Apple Watch 单品稿的建议使用顺序：`v3` 适合审结构与系统方法论；`v4` 更适合直接看上线版式与实际发稿节奏。

68. 2026-03-10 已生成跨品牌智能手表挑选推荐攻略正式稿：zhihu_smartwatch_buying_guide_20260310_final.md，定位为知乎搜索型选购长文，内容结构为路线分流、六维对比、预算分层、系列速选与最终缩圈顺序。
69. 2026-03-10 已生成对应正式 PDF：publish_assets/zhihu_smartwatch_guide_20260310/final/zhihu_smartwatch_buying_guide_20260310_final.pdf，并导出 pdf_preview_page_1.jpg、pdf_preview_page_2.jpg 供快速审稿。
70. 2026-03-10 该攻略图像素材使用官方无水印产品图：Apple、华为、Garmin 三张主图分别位于 publish_assets/zhihu_smartwatch_guide_20260310/01_apple.jpg、 2_huawei.png、 3_garmin.jpg，适合作为正式图文底稿示例。
71. 2026-03-10 智能手表攻略素材目录为 publish_assets/zhihu_smartwatch_guide_20260310，其中官方主图文件为 01_apple.jpg、02_huawei.png、03_garmin.jpg。
